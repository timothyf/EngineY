...
# This class provides tests for the RESTful API of the Friendship object.
class FriendshipsTest < ActionController::IntegrationTest
  ...
  test "get a users friends" do
    ...
    assert friends[0]['id'] == 8, 'Incorrect friend id'
    assert friends[0]['login'] == 'user8', 'Incorrect friend login'
    assert friends[0]['first_name'] == 'Test8', 'Incorrect friend first name' 
