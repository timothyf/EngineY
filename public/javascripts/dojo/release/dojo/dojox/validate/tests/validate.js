	...
	[{
		...
		setUp: function(){
			...
			for(var i = 0 ; i < localeList.length; i ++){
				dojo.requireLocalization("dojo.cldr", "currency", localeList[i], "ROOT,de,en,en-au,en-ca,en-us,es,fr,it,ja,ko,pt,zh,zh-tw");
				dojo.requireLocalization("dojo.cldr", "number", localeList[i], "de,de-de,en,en-au,en-gb,en-us,es,es-es,fr,it,ja,ja-jp,ko,ko-kr,ROOT,pt,zh,zh-cn,zh-tw");
			}
		},
